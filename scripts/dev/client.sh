...
clientCommand="cd client && node --max_old_space_size=4096 node_modules/.bin/ng serve --no-live-reload --proxy-config proxy.config.json --hmr --configuration $clientConfiguration --host 0.0.0.0 --disable-host-check --port 3000"
